package pk.training.basit.authorizationserver.oauth2.customizer.jwt;

import org.springframework.security.oauth2.server.authorization.token.JwtEncodingContext;

import pk.training.basit.authorizationserver.oauth2.customizer.jwt.impl.DefaultJwtCustomizerHandler;
import pk.training.basit.authorizationserver.oauth2.customizer.jwt.impl.OAuth2AuthenticationTokenJwtCustomizerHandler;
import pk.training.basit.authorizationserver.oauth2.customizer.jwt.impl.UsernamePasswordAuthenticationTokenJwtCustomizerHandler;
